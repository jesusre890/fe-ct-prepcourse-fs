...
function numeroMasGrande(arrayOfNums) {
   ...
   // return Math.max(...arrayOfNums);(OPCION 1)
...
//       }
//    }
//    return maximo(OPCION 2)

// let arrayOfNums = [1, 8, 6, 13, 52, 1]
//                    0  1  2  3   4   5
   let maximo = 0;
...
function multiplicarArgumentos() {
   ...
   //       numMultiplicados = numMultiplicados * arguments[i];
   //    }
   // }
...
function diaDeLaSemana(numeroDeDia) {
   ...
   // let numeroDeDia = [1,   2,   3,   4,   5,   6,   7]
   // key                0    1    2    3    4    5    6
   // dia                dom  lun  mar  mie  jue  vie  sabado
   // for(let i = 0; i < numeroDeDia.length; i++){
   //    if((numeroDeDia[i] = 0) || (numeroDeDia[i] = 6)){
